...
public class SimplifiedHandMapper : MonoBehaviour
{
    ...
    public List<Transform> bonesToSkip;//use if there are more fake bones than real bones
    ...
    {   
        ...
        foreach(OVRBone bone in realBones){
          ...
          fakeHandPoints[bonesCounter].transform.rotation = bone.Transform.rotation;

          fakeBones[bonesCounter].transform.position = fakeHandPoints[bonesCounter].transform.position;
          fakeBones[bonesCounter].transform.rotation = fakeHandPoints[bonesCounter].transform.rotation;
